...
<div class="gradient"></div></div>
                        ...
                        <div class="oas-layout-cell oas-content"><article class="oas-post oas-article">
                                <div class="oas-postmetadataheader">
                                        <h2 class="oas-postheader"><span class="oas-postheadericon">Register Now!</span></h2>
                                    </div>
...
<div class="oas-content-layout layout-item-0">
    <div class="oas-content-layout-row">
    <div class="oas-layout-cell layout-item-1" style="width: 33%" >
        <p style="text-align: center;"><span style="color: rgb(226, 52, 29); font-weight: bold; font-size: 24px;">Doctor</span><br></p><p style="text-align: center;"><a href="doctorreg.php"><img width="184" height="184" alt="" class="oas-lightbox" src="images/People-Doctor-Male-icon.png"></a><br></p><p style="text-align: center;"><span style="font-size: 20px;">To Register</span></p><p style="text-align: center;"><a href="doctorreg.php" target="_self" title="Registration of a Doctor" style="font-size: 20px; " class="oas-button">Click Here</a></p>
    </div><div class="oas-layout-cell layout-item-2" style="width: 34%" >
        <p style="text-align: center;"><span style="color: rgb(124, 150, 177); font-weight: bold; font-size: 24px;">Patient</span><br></p><p style="text-align: center;"><a href="patientreg.php"><img width="192" height="192" alt="" class="oas-lightbox" src="images/People-Patient-Male-icon.png"></a><br></p><p style="text-align: center;"><span style="font-size: 20px;">To Register&nbsp;</span></p><p style="text-align: center;"><a href="patientreg.php" target="_self" title="Registration of a Patient" style="font-size: 20px;" class="oas-button">Click Here</a></p>
    </div><div class="oas-layout-cell layout-item-3" style="width: 33%" >
        <p style="text-align: center;"><span style="color: rgb(18, 191, 32); font-weight: bold; font-size: 24px;">Pharmacist</span><br></p><p style="text-align: center;"><a href="pharmacyreg.php"><img width="184" height="184" alt="" class="oas-lightbox" src="images/Medical-Pharmacist-Male-Light-icon.png"></a><br></p><p style="text-align: center;"><span style="font-size: 20px;">To Register</span><br></p><p style="text-align: center;"><a href="pharmacyreg.php" target="_self" title="Registration of a Pharmacist" style="font-size: 20px; " class="oas-button">Click Here</a></p>
    </div>
    </div>
</div>
</div>
