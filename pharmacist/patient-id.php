...
$search=$_POST['search'];
					...
					$sel=mysql_query("select * from prescription where name 			like'$search'") or die(mysql_error());
...
<ul class="ph-vmenu"><li><a href="profile.php" class="active">Profile</a></li><li><a href="patient-id.php">Patient ID</a></li><li><a href="../drugstorelogin.php?action=logout">Logout</a></li></ul>
    ...
    <div class="ph-layout-cell layout-item-1" style="width: 100%" >
        <p style="text-align: center;"><span style="font-size: 26px; font-weight: bold; color: #6F8295;">Enter Patient's Name</span></p>
    </div>
    </div>
</div>
<div class="ph-content-layout layout-item-0">
    ...
    <div class="ph-layout-cell layout-item-2" style="width: 25%" >
        ...
        <p><p><p><p><form id="form1" name="form1" method="post" action="patient-id.php">
          <table width="200" border="0" style="margin-right: auto; margin-left: auto; ">
            <tbody>
              <tr>
                <td><input value="" type="text" name="search"></td>
              <tr>
          ...
          <table width="399" border="0">
            ...
            <tr>
              <td width="201">Patient's Name</td>
              <td width="121">Medicines</td>
            </tr>
