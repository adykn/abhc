...
<nav class="ph-nav">
    <ul class="ph-hmenu"><li><a href="home.html" class="">Home</a></li><li><a href="contact-us.php" class="">Contact Us</a></li><li><a href="about-us.php" class="active">About Us</a></li></ul> 
    </nav>
...
<ul class="ph-vmenu"><li><a href="profile.php" class="">Profile</a></li><li><a href="patient-id.php" class="">Patient ID</a></li><li><a href="../drugstorelogin.php?action=logout">Logout</a></li></ul>
                
        </div>
</div></div>
                        <div class="ph-layout-cell ph-content"><article class="ph-post ph-article">
                                <div class="ph-postmetadataheader">
                                        <h2 class="ph-postheader"><span class="ph-postheadericon">About Us</span></h2>
                                    </div>
                                                
                <div class="ph-postcontent ph-postcontent-0 clearfix"><p><br></p></div>
