...
if($_GET['action']=="drugstore-login"){
	$username=$_POST['username'];
	$password=$_POST['password'];
	$sel=mysql_query("select * from pharmacy");
	while($ss=mysql_fetch_array($sel)){
		...
		if($username==$userdb && $password==$passdb){
			...
			header("location:patient-id.php");
		}
...
<div id="wrapper">
 	...
 	<form name="login-form" class="login-form" action="patientlogin.php?action=patient-login" method="post" id="login-form">
 		...
 		<p style="text-align: left;"><span>
 		 <select name="URL" onchange="window.location.href=this.form.URL.options&#91;this.form.URL.selectedIndex&#93;.value"><option selected="selected">Pharmacist</option><option value="../patientpanel/patntlogin.php">Patient</option><option value="../doctorpanel/dtrlogin.php">Doctor</option></select>
 	 .</span></p>
 		<p><!--?php echo="" $msg;?=""?--></p>
</div>
...
<div class="oas-content-layout">
    ...
    <div class="oas-layout-cell" style="width: 25%" >
        ...
        <div id="wrapper">
         	...
         	<form name="login-form" class="login-form" action="drugstrlogin.php?action=drugstore-login" method="post" id="login-form">
         	
         		<div class="header">
         		<h1>Registered? Login Here</h1>
         		<p><span style="color: #E2341D;">Who are You???</span></p>
         		<p style="text-align: left;">Select:<span>
         		 <select name="URL" onchange="window.location.href=this.form.URL.options[this.form.URL.selectedIndex].value"><option selected="selected">Pharmacist</option><option value="../doctorpanel/dtrlogin.php">Doctor</option><option value="../patientpanel/patntlogin.php">Patient</option></select>
         	 .</span></p>
         		<p><!--?php echo="" $msg;?=""?--></p>
        </div>
