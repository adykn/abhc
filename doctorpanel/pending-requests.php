...
<html dir="ltr" lang="en-US"><head><!-- Created by Artisteer v4.1.0.59861 -->
    <meta charset="utf-8">
    <title>Patient Pending Requests</title>
...
<li><a href="appointments.php" class="">Today's Appointments</a></li><li><a href="pending-requests.php" class="active">Pending Requests</a></li><li><a href="patients.php">Patients</a></li><li><a href="doctorlogin.php?action=logout">Logout</a></li></ul>
        ...
        <div class="art-blockcontent"><h2><a href="appointments.html" target="_self" title="Check Patient Appointment Request">Check Appointments</a></h2></div>
                        ...
                        <div class="art-layout-cell art-content"><article class="art-post art-article">
                                <div class="art-postmetadataheader">
                                        <h2 class="art-postheader"><span class="art-postheadericon">Patient Pending Requests</span></h2>
                                    </div>
