...
if($_GET['action']=="register")
{
	...
	$name=$_POST['name'];
	$conctact=$_POST['contact'];
	$bloodgroup=$_POST['bloodgroup'];
	$city=$_POST['city'];
	$address=$_POST['address'];
	$district=$_POST['district'];
	
	$ins=mysql_query("insert into blooddonor (name,contact,bloodgroup,city,address,district)values('$name','$conctact','$bloodgroup','$city','$address','district')")or die(mysql_error());
	}
                          ...
                          <form id="form1" name="form1" method="post" action="doctorreg.php?action=register">
                            <table width="348" height="252" border="0">
                              ...
                              <tr>
                                ...
                                <td bgcolor="#FFFFFF"><input value="" type="text" name="contact" id="contact"></td>
                              </tr>
                              <tr>
                                <td height="28" bgcolor="#FFFFFF">Blood Group</td>
                                <td bgcolor="#FFFFFF"><select name="bloodgroup" id="bloodgroup">
                                  <option>A+ve</option>
                                  <option>A-ve</option>
                                  <option>AB+ve</option>
                                  <option>AB-ve</option>
                              ...
                              <tr>
                                ...
                                <td bgcolor="#FFFFFF"><input value="" type="text" name="city" id="city"></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td height="27" bgcolor="#FFFFFF">District</td>
                                <td bgcolor="#FFFFFF"><input type="text" name="district" id="district"></td>
                              </tr>
                              <tr>
