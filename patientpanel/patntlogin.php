...
if($_GET['action']=="patient-login"){
	
	$username=$_POST['username'];
	$password=$_POST['password'];
	$sel=mysql_query("select * from patients") or die(mysql_error());
...
<div id="wrapper">
 	...
 	<form name="login-form" class="login-form" action="patntlogin.php?action=patient-login" method="post" id="login-form">
 	
 		<div class="header">
 		<h1>Who Are You?</h1>
 		<p><span style="color: #E2341D;">Select From The List!</span></p>
 		<p style="text-align: left;"><span>
 		 <select name="URL" onchange="window.location.href=this.form.URL.options&#91;this.form.URL.selectedIndex&#93;.value"><option selected="selected">Patient</option><option value="../doctorpanel/dtrlogin.php">Doctor</option><option value="../pharmacist/drugstrlogin.php">Pharmacist</option></select>
 		</span></p>
 		<p><!--?php echo="" $msg;?=""?--></p>
</div>
