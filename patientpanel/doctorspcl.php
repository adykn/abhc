...
<div class="oas-content-layout layout-item-0">
    <div class="oas-content-layout-row">
    <div class="oas-layout-cell layout-item-1" style="width: 100%" >
        <table>
    ...
    </div><div class="oas-layout-cell layout-item-2" style="width: 0%" >
        
    </div><div class="oas-layout-cell layout-item-3" style="width: 0%" >
